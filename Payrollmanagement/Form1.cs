...
namespace Payrollmanagement
{
    public partial class Form1 : Form
    {
        ...
        private void insertbutton_Click(object sender, EventArgs e)
        {
            ...
            double House_Rent;
            House_Rent = (Convert.ToDouble(Basic_Salary))*20/100;
            double Medical;
            Medical = (Convert.ToDouble(Basic_Salary))*15/100;
            double Tax;
            Tax = (Convert.ToDouble(Basic_Salary))*5/100;
            double Total_Salary;
            Total_Salary = Convert.ToDouble(Basic_Salary) + House_Rent + Medical - Tax;


            string insertQuery = "insert into payroll(Employee_ID,Employee_Name,Basic_Salary,House_Rent,Medical,Tax,Toatal_Salary)values('" + Employee_ID + "','" + Employee_Name + "','" + Basic_Salary + "','" + House_Rent + "','" + Medical + "','" + Tax + "','" + Total_Salary + "')";
